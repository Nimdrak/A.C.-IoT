...
#define SEDGENUM 19 	// number of edges: 19
...
#define CAPACITY_LIMIT 400	// cn(l)/C-c(l)
...
int main(int argc, char* argv[]) {
	...
	int n_request = 60;	// the number of new requests
	...
	bool generalized_ver = false;	// true: consider network provisioning, false: admission control
	bool check_profitability = false;	
	
	double scailing_constant = atof(argv[6]);
	double profit_scailing_constant_1 = 3;
	double profit_scailing_constant_2 = 3;
...
/* ======================================== LP2: Generalized Version with profitability check (our model, minimize cost, greedy, gurobi) ======================================== */
	
	if (generalized_ver == true && check_profitability == true) {
		for (int i=0; i<n_request; i++) {
			int flow_number;	
