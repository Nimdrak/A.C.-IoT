...
for qos in 0.01 #0.05 0.1
do
	case "$qos" in
		0.01)
			approximation_slope="0.0344876"
			approximation_constant="0.0925728"
			expansion_point="2.32"
			;;	
		0.03)
			approximation_slope="0.0861516"
			approximation_constant="0.199893"
			expansion_point="1.88"
			;;
		0.05)
			approximation_slope="0.126606"
			approximation_constant="0.270963"
			expansion_point="1.64"
			;;
		0.06)
			approximation_slope="0.142079"
